...
<div class="container clearfix">
		...
		<a class='crumbs_nav_item'><em class='blue'>实录管理</em></a>
		</div>
        <div class="content">
            <ul class="user_tab clearfix" id="user_tab_ac">
                <!--给最后一个li加class为last-->
                <li class='<?php if($_GET['status'] == '0' || $_GET['status'] == '') echo $class_a;?>  a1'><a href="<?php echo Yii::app()->request->baseUrl;?>/event/event/">已发布的</a></li>
                <li class='<?php if($_GET['status'] == '1') echo $class_a;?>  a2'><a href="<?php echo Yii::app()->request->baseUrl;?>/event/event/index/status/1">草稿</a></li>
            </ul>
