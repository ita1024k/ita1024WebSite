...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'user_id',array('size'=>30,'maxlength'=>30)); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'nums'); ?>
		<?php echo $form->textField($model,'nums',array('size'=>50,'maxlength'=>50)); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'language',array('size'=>22,'maxlength'=>22)); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'support',array('size'=>30,'maxlength'=>30)); ?>
	</div>
